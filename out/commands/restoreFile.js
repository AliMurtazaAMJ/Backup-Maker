...
exports.registerRestoreFile = registerRestoreFile;
const vscode = __importStar(require("vscode"));
const types_1 = require("../types");
function registerRestoreFile(context, restoreService) {
    const disposable = vscode.commands.registerCommand('backupManager.restoreFile', async (item) => {
        try {
