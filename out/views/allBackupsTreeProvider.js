...
exports.AllBackupsTreeProvider = void 0;
const vscode = __importStar(require("vscode"));
const types_1 = require("../types");
const backup_1 = require("../models/backup");
class AllBackupsTreeProvider {
    metadataService;
    ...
    getRootItems() {
        ...
        for (const projectName of projects) {
            items.push(new backup_1.BackupTreeItem(projectName, vscode.TreeItemCollapsibleState.Collapsed, types_1.BackupTreeItemType.Project));
        }
        return items;
    }
...
exports.AllBackupsTreeProvider = AllBackupsTreeProvider;
//# sourceMappingURL=allBackupsTreeProvider.js.map